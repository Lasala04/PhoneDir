...
class _EditPhoneScreenState extends State<EditPhoneScreen> {
  ...
  void initState() {
    ...
    _priceController =
        TextEditingController(text: widget.phone.price.toStringAsFixed(2));
    _descriptionController =
        TextEditingController(text: widget.phone.description);
    _imageUrlController = TextEditingController(text: widget.phone.imageUrl);
    _imagePreviewUrl = widget.phone.imageUrl;
  ...
  Future<void> _submitForm() async {
    ...
    final success = await _apiService.updatePhone(updatedPhone);
    ...
    if (mounted) {
      ...
      if (success) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Phone updated successfully'),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Failed to update phone. Please try again.'),
